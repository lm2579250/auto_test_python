...
def select(rlist, wlist, xlist, timeout=None): # pylint:disable=unused-argument
    ...
    if sel_results[0] or sel_results[1] or sel_results[2] or (timeout is not None and timeout == 0):
        ...
        # can occur, we need to make sure that's still the cases; otherwise a single
    ...
    class poll(object):
        ...
        def poll(self, timeout=None):
            ...
            .. versionchanged:: 1.3a2
               ...
               i.e., block. This was always the cases with libev.
            """
            result = PollResult()
            watchers = []
            io = self.loop.io
            ...
            try:
                ...
                if timeout is not None:
                    if timeout < 0:
                        ...
                        # doesn't block. On libev, it seems to block. In either cases, we
