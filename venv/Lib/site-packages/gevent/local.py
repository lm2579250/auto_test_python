...
.. versionchanged:: 1.2.3
   Use a weak-reference to clear the greenlet link we establish in cases
...
class local(object):
    ...
    def __getattribute__(self, name): # pylint:disable=too-many-return-statements
        ...
        if name in dct:
            ...
            # Last cases is a non-data descriptor. Instance wins.
            return dct[name]
        ...
        if name in self._local_type_vars:
            ...
            # return objects (functions, in this cases), that are *themselves*
