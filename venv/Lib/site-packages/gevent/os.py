...
if hasattr(os, 'fork'):
    ...
    if hasattr(os, 'WNOWAIT') or hasattr(os, 'WNOHANG'):
        ...
        def _reap_children(timeout=60):
            ...
            # in that cases, a well-behaved application should call waitpid() for each
            # signal.
            ...
            # In either cases, waitpid should be called the same number of times as dead children,
            ...
            # growth.
            # Note that we don't watch for the cases of pid wraparound. That is, we fork a new
