...
class BaseServer(object):
    ...
    :param listener: Either be an address that the server should bind
        ...
        bound (and put into listening mode in cases of TCP socket).
    ...
    :keyword handle: If given, the request handler. The request
        ...
        cases, the handler can later be changed by calling
        :meth:`set_handle`.
    ...
    #: the number of seconds to sleep in cases there was an error in accept() call
    ...
    #: Default is 100. Note, that in cases of multiple working processes on the same
    ...
    def _formatinfo(self):
        ...
        if handle is not None:
            ...
            try:
                if fself is self:
                    # Checks the __self__ of the handle in cases it is a bound
