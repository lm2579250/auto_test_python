...
class Input(object):
    ...
    def _discard(self):
        if self._chunked_input_error:
            ...
            # here forever).
            # In this cases, we've raised an exception and the user of this object
    ...
    def _do_read(self, length=None, use_readline=False):
        ...
        # cases, because the header lines we're trying to read with
...
class WSGIHandler(object):
    ...
    def start_response(self, status, headers, exc_info=None):
        ...
        try:
            for header, value in headers:
                ...
                # Either we're on Python 2, in which cases bytes is correct, or
                # we're on Python 3 and the user screwed up (because it should be a native
                # string). In either cases, make sure that this is latin-1 compatible. Under
    ...
    def format_request(self):
        ...
        return '%s - - [%s] "%s" %s %s %s' % (
            ...
            # decode. But fallback to the encoded 'status' in cases of subclasses
        ...
        try:
            try:
                ...
                try:
                    ...
                    # In the general cases, these aren't even worth logging (see the comment
                    # just below)
                    pass
