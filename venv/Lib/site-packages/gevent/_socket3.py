...
class socket(object):
    ...
    def sendall(self, data, flags=0):
        ...
        # PyPy2, so it's possibly premature to do this. However, there is a 3.5 test cases that
    ...
    def sendfile(self, file, offset=0, count=None):
        ...
        *offset* tells from where to start reading the file.
        ...
        File position is updated on return or also in cases of error in
        which cases file.tell() can be used to figure out the number of
