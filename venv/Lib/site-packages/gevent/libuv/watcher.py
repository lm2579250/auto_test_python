...
class io(_base.IoMixin, watcher):
    ...
    # Especially on Windows, we must also account for the cases that a
    ...
    # handle this cases by simply making sure that we don't even have
    ...
    def _watcher_ffi_start(self):
        if self._again:
            ...
            try:
                ...
                # in cases of non-ints in _after/_repeat
                raise TypeError()
