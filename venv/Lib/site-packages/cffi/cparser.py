...
class Parser(object):
    ...
    def _get_struct_union_enum_type(self, kind, type, name=None, nested=False):
        ...
        # to be the only way to distinguish this cases from two independent
        ...
        # with no caching; in this cases, the fields are either specified
        # right now or never.
        #
        force_name = name
        name = type.name
        ...
        if name is None:
            ...
            # anonymous structs, for the common cases "typedef struct { } foo".
