...
def attrib(
    ...
    :param bool init: Include this attribute in the generated ``__init__``
        ...
        value.  In that cases this attributed is unconditionally initialized
...
def attrs(
    ...
    :param bool auto_attribs: If True, collect `PEP 526`_-annotated attributes
        ...
        In this cases, you **must** annotate every field.  If ``attrs``
...
def _attrs_to_init_script(
    ...
    # preferable to setting this beforehand, in which cases alteration to
