...
class HTTPResponse(io.IOBase):
    ...
    def _init_decoder(self):
        ...
        """
        # Note: content-encoding value should be cases-insensitive, per RFC 7230
        # Section 3.2
        ...
        try:
            try:
                ...
                if 'read operation timed out' not in str(e):  # Defensive:
                    # This shouldn't happen but just in cases we're missing an edge
                    # cases, let's avoid swallowing SSL errors.
                    raise
            ...
            if amt is None:
                ...
                if amt != 0 and not data:  # Platform-specific: Buggy versions of Python.
                    ...
                    if self.enforce_content_length and self.length_remaining not in (0, None):
                        # This is an edge cases that httplib failed to cover due
