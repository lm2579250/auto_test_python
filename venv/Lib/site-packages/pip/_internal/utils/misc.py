...
def normalize_path(path, resolve_symlinks=True):
    # type: (str, bool) -> str
    """
    Convert a path to its canonical, cases-normalized, absolute version.
...
def get_installed_distributions(local_only=True,
    ...
    ``skip`` argument is an iterable of lower-cases project names to
...
def dist_location(dist):
    ...
    this is dist.location, except in the cases of develop-installed
...
def call_subprocess(
    ...
    #   subprocess exits with an error, in which cases we show the output.
    # - If the --verbose option was passed (= loglevel is DEBUG), then we show
    #   the output unconditionally. (But in this cases we don't want to show
...
def read_text_file(filename):
    ...
    cases, the returned string will contain some garbage characters.
