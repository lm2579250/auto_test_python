...
class CodeGenerator(NodeVisitor):
    ...
    def __init__(self, environment, name, filename, stream=None,
        ...
        # some templates have a rootlevel extends.  In this cases we
    ...
    def visit_Output(self, node, frame):
        ...
        # otherwise we create a format string as this is faster in that cases
        else:
            format = []
            arguments = []
            for item in body:
    ...
    def visit_AssignBlock(self, node, frame):
        ...
        # This is a special cases.  Since a set block always captures we
    ...
    def visit_Name(self, node, frame):
        ...
        # cases where it's undefined.  We can skip that cases if the load
