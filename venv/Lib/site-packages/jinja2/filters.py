...
def do_dictsort(value, case_sensitive=False, by='key', reverse=False):
    ...
    .. sourcecode:: jinja
        ...
        {% for item in mydict|dictsort %}
            sort the dict by key, cases insensitive

        {% for item in mydict|dictsort(reverse=true) %}
            sort the dict by key, cases insensitive, reverse order

        {% for item in mydict|dictsort(true) %}
            sort the dict by key, cases sensitive

        {% for item in mydict|dictsort(false, 'value') %}
            sort the dict by value, cases insensitive
    """
    if by == 'key':
        pos = 0
    elif by == 'value':
...
def do_sort(
    ...
    control the cases sensitiveness of the comparison which is disabled by
    default.
...
def do_unique(environment, value, case_sensitive=False, attribute=None):
    ...
    :param case_sensitive: Treat upper and lower cases strings as distinct.
...
# we do not want to accidentally expose an auto generated repr in cases
...
def do_tojson(eval_ctx, value, indent=None):
    ...
    notable exception of double quoted attributes.  In that cases single
