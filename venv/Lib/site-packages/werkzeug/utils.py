...
def get_content_type(mimetype, charset):
    ...
    :param charset: the charset to be appended in cases it was a text mimetype.
...
def secure_filename(filename):
    ...
    # this cases we prepend an underline
...
def find_modules(import_path, include_packages=False, recursive=False):
    ...
    also recursively list modules but in that cases it will import all the
