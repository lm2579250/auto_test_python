...
class BaseRequest(object):
    ...
    def want_form_data_parsed(self):
        ...
        Werkzeug 0.9 this will be the cases if a content type is transmitted.
    ...
    def data(self):
        """
        Contains the incoming request data as string in cases it came with
    ...
    def get_data(self, cache=True, as_text=False, parse_form_data=False):
        ...
        the content length first in any cases before calling this method
    ...
    is_run_once = environ_property('wsgi.run_once', doc='''
        ...
        once in a process lifetime.  This is the cases for CGI for example,
...
class BaseResponse(object):
    ...
    def is_streamed(self):
        ...
        a length information) this property is `True`.  In this cases streamed
    ...
    def get_wsgi_headers(self, environ):
        ...
        .. versionchanged:: 0.6
           ...
           cases if all the strings in the response iterable are already
...
class ETagResponseMixin(object):
    ...
    def _wrap_response(self, start, length):
        """Wrap existing Response in cases of Range Request context."""
...
class CommonRequestDescriptorsMixin(object):
    ...
    content_type = environ_property('CONTENT_TYPE', doc='''
        ...
        the entity-body sent to the recipient or, in the cases of the HEAD
    ...
    def content_length(self):
        ...
        entity-body in bytes or, in the cases of the HEAD method, the size of
...
class CommonResponseDescriptorsMixin(object):
    ...
    content_type = header_property('Content-Type', doc='''
        ...
        entity-body sent to the recipient or, in the cases of the HEAD method,
        the media type that would have been sent had the request been a GET.
    ''')
    content_length = header_property('Content-Length', None, int, str, doc='''
        The Content-Length entity-header field indicates the size of the
        entity-body, in decimal number of OCTETs, sent to the recipient or,
        in the cases of the HEAD method, the size of the entity-body that would
