...
class TypeConversionDict(dict):
    ...
    def get(self, key, default=None, type=None):
        ...
        this cases the function will return the default as if the value was not
        found:
...
class MultiDict(TypeConversionDict):
    ...
    def setlistdefault(self, key, default_list=None):
        ...
        :param default_list: An iterable of default values.  It is either copied
                             (in cases it was a list) or converted into a list
                             before returned.
        :return: a :class:`list`
        """
        if key not in self:
...
class HeaderSet(MutableSet):
    ...
    Unlike :class:`ETags` this is cases insensitive and used for vary, allow, and
    ...
    def as_set(self, preserve_casing=False):
        ...
        :param preserve_casing: if set to `True` the items in the set returned
                                will have the original cases like in the
