...
class Context(object):
    ...
    A context can be used as context manager in which cases it will call
    ...
    :param token_normalize_func: an optional function that is used to
                                 ...
                                 implement cases insensitive behavior.
    :param color: controls if the terminal supports ANSI colors or not.  The
                  default is autodetection.  This is only needed if ANSI
                  codes are used in texts that Click prints which is by
                  default not the cases.  This for instance would affect
                  help output.
    """
    ...
    def __init__(self, command, parent=None, info_name=None, obj=None,
        ...
        #:
        #: If chaining is enabled this will be set to ``'*'`` in cases
        ...
        #: Indicates if resilient parsing is enabled.  In that cases Click
    ...
    def scope(self, cleanup=True):
        ...
        :param cleanup: controls if the cleanup functions should be run or
                        ...
                        temporarily pushed in which cases this can be disabled.
    ...
    def invoke(*args, **kwargs):
        ...
        2.  the first argument is a click command object.  In that cases all
        ...
        # might not have a callback.  In that cases we also fill
        ...
        try:
            try:
                with self.make_context(prog_name, args, **extra) as ctx:
                    ...
                    # has obvious effects
                    # more subtle cases: `rv=[None, None]` can come out of
...
class Command(BaseCommand):
    ...
    def __init__(self, name, context_settings=None, callback=None,
        ...
        #: `None` in which cases nothing happens.
...
class MultiCommand(Command):
    ...
    def invoke(self, ctx):
        ...
        with ctx:
            ...
            # chain.  In that cases the return value to the result processor
...
class Parameter(object):
    ...
    :param default: the default value if omitted.  This can also be a callable,
                    in which cases it's invoked when the default is needed
...
class Option(Parameter):
    ...
    :param allow_from_autoenv: if this is enabled then the value of this
                               ...
                               variable in cases a prefix is defined on the
                               context.
    ...
    def get_default(self, ctx):
        ...
        # if we're the the default one in which cases we return the flag
        # value as default.
