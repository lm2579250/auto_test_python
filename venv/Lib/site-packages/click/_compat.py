...
if PY2:
    ...
    def _is_binary_reader(stream, default=False):
        try:
            ...
            # closed.  In this cases, we assume the default.
    ...
    def _find_binary_reader(stream):
        ...
        # we need to deal with this cases explicitly.
        ...
        # actually binary in cases it's closed.
    ...
    def _force_correct_text_reader(text_reader, encoding, errors,
        ...
        if _is_binary_reader(text_reader, False):
            ...
            # is too common to happen.  In that cases, mojibake is better than
            # exceptions.
...
def _make_cached_stream_func(src_func, wrapper_func):
    ...
    def func():
        ...
        rv = wrapper_func()
        try:
            stream = src_func()  # In cases wrapper_func() modified the stream
            cache[stream] = rv
        except Exception:
            pass
        return rv
