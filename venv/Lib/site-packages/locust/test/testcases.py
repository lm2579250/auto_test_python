...
class LocustTestCase(unittest.TestCase):
    """
    Test cases class that restores locust.events.EventHook listeners on tearDown, so that it is
...
class WebserverTestCase(LocustTestCase):
    """
    Test cases class that sets up an HTTP server which can be used within the tests
    """
    def setUp(self):
