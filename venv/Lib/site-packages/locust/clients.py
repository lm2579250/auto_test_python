...
class HttpSession(requests.Session):
    ...
    can now take a *url* argument that's only the path part of the URL, in which cases the host
...
class ResponseContextManager(LocustResponse):
    ...
    def failure(self, exc):
        ...
        exc can be either a python exception, or a string in which cases it will
