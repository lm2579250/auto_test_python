...
def fix_switch_cases(switch_node):
    """ The 'cases' statements in a 'switch' come out of parsing with one
        child node, so subsequent statements are just tucked to the parent
        Compound. Additionally, consecutive (fall-through) cases statements
    ...
    for child in switch_node.stmt.block_items:
        if isinstance(child, (c_ast.Case, c_ast.Default)):
            ...
            # 1. Add it to the Compound and mark as "last cases"
            ...
            # Other statements are added as children to the last cases, if it
            # exists.
