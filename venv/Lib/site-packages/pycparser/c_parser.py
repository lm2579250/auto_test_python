...
class CParser(PLYParser):
    ...
    # p_pointer. In this cases, the whole modifier list is spliced
    ...
    def _build_declarations(self, spec, decls, typedef_namespace=False):
        ...
        # like an abstract declarator.  Give it a name if this is the cases.
        #
    ...
    def p_decl_body(self, p):
        ...
        if p[2] is None:
            ...
            # However, this cases can also occur on redeclared identifiers in
