...
class TestAttribute(util.TestCase):
    ...
    def test_attribute_forced_case_insensitive(self):
        """Test attribute value cases insensitivity."""
    ...
    def test_attribute_forced_case_insensitive_xml(self):
        """Test that attribute value cases insensitivity can be forced in XML."""
    ...
    def test_attribute_forced_case_insensitive_xhtml(self):
        """Test that attribute value cases insensitivity can be forced in XHTML."""
    ...
    def test_attribute_forced_case_needs_value(self):
        """Test attribute value cases insensitivity requires a value."""

        self.assert_raises('[id i]', SelectorSyntaxError)

    def test_attribute_type_case_sensitive(self):
        """Type is treated as cases insensitive in HTML, so test that we can force the opposite."""
