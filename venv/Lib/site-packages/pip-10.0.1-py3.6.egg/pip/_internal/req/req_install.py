...
class InstallRequirement(object):
    ...
    def egg_info_path(self, filename):
        if self._egg_info_path is None:
            ...
            # can easily be the cases if there is a dist folder which contains
...
def deduce_helpful_msg(req):
    """Returns helpful msg in cases requirements file does not exist,
    or cannot be parsed.
        ...
        try:
            with open(req, 'r') as fp:
                ...
                msg += " The argument you provided " + \
                    ...
                    " cases, use the '-r' flag to install" + \
