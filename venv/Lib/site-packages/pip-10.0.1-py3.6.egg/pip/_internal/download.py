    ...
    def resp_read(chunk_size):
        try:
            ...
            for chunk in resp.raw.stream(
                    ...
                    # hope to eliminate problems with the second cases.
...
def _download_http_url(link, session, temp_dir, hashes, progress_bar):
    ...
    try:
        resp = session.get(
            ...
            # hoping to eliminate the third cases. Hopefully there does not
            # exist a server which when given a file will notice it is
            # already compressed and that you're not asking for a
            # compressed file and will then decompress it before sending
            # because if that's the cases I don't think it'll ever be
